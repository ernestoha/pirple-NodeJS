...
logs.public.add4Server001 = function (data, callback) {//For FrontEnd
...
logs.public.add4Server002 = function (data, callback) { //For Backend
        logs.add4Server("002", data, function(err){
            callback(err);
        });
};

logs.public.add4Server003 = function (data, callback) { //For CLI
        logs.add4Server("003", data, function(err){
            callback(err);
        });
};
